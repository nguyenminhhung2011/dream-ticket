...
//    public ResponseEntity<?> handleException(NotFoundException ex, WebRequest req){
...
//    }
//    @ExceptionHandler(value = NotFoundException.class)
//    public ResponseEntity<?> handlerNotFoundException(UnauthorizedException ex, WebRequest req){
//        ErrorResponse errorResponse = new ErrorResponse(ex.getMessage(),new Timestamp(new Date().getTime()));
//        return new ResponseEntity<>(errorResponse,HttpStatus.NOT_FOUND);
//    }
